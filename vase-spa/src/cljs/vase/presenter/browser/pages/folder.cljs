(ns vase.presenter.browser.pages.folder
  (:require [goog.events :as gevents]
            [goog.Uri :as guri]
            [goog.History]
            [reagent.core :as r]

            [vase.controller.read-folder.by-list
             :as by-list]
            [vase.controller.read-folder.by-double-image-viewer
             :as by-double]
            [vase.controller.read-folder.by-single-image-viewer
             :as by-single]

            [vase.components.header.reagent
             :refer [header]]
            [vase.components.tag-edit-button.reagent
             :refer [tag-edit-button]]
            [vase.components.tag_editing.reagent
             :refer [modal-editing-tag]]
            [vase.components.viewer.single-image.reagent
             :refer [single-image-viewer]]
            [vase.components.viewer.double-image.reagent
